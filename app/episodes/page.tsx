    ...
    <div>
      <div className="flex-1 flex flex-col overflow-hidden">
        <main className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 bg-[#FAFAF9]">
          <div className="flex items-center gap-2 mb-6 sm:mb-8 bg-white p-1 rounded-2xl border border-gray-200 overflow-x-auto scrollbar-thin">
            {(
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-1">
                        <span
                          className={`px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider ${getStatusStyle(episode.status)}`}
                        >
                          {episode.status}
                        </span>
