...
function DashboardContent() {
  ...
  const getStatusBadge = (status: Session["status"]) => {
    ...
    return (
      ...
      >
        <span
          className={`w-1.5 h-1.5 rounded-full ${status === "active" ? "bg-green-500" : status === "scheduled" ? "bg-blue-500" : "bg-gray-400"}`}
        ></span>
        {labels[status]}
      </span>
    );
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 mb-4 sm:mb-6">
          <div className="flex items-center gap-1 overflow-x-auto pb-1 scrollbar-thin">
            <button
              ...
              className={`px-3 sm:px-4 py-2 rounded-lg text-sm font-medium transition-colors whitespace-nowrap ${activeFilter === "all" ? "bg-gray-100 text-gray-900" : "text-gray-500 hover:text-gray-700 hover:bg-gray-50"}`}
            >
              All
            </button>
            <button
              onClick={() => setActiveFilter("active")}
              className={`px-3 sm:px-4 py-2 rounded-lg text-sm font-medium transition-colors whitespace-nowrap ${activeFilter === "active" ? "bg-gray-100 text-gray-900" : "text-gray-500 hover:text-gray-700 hover:bg-gray-50"}`}
            >
              Active ({stats.active})
            </button>
            <button
              onClick={() => setActiveFilter("completed")}
              className={`px-3 sm:px-4 py-2 rounded-lg text-sm font-medium transition-colors whitespace-nowrap ${activeFilter === "completed" ? "bg-gray-100 text-gray-900" : "text-gray-500 hover:text-gray-700 hover:bg-gray-50"}`}
            >
              Completed ({stats.completed})
            </button>
            <button
              onClick={() => setActiveFilter("scheduled")}
              className={`px-3 sm:px-4 py-2 rounded-lg text-sm font-medium transition-colors whitespace-nowrap ${activeFilter === "scheduled" ? "bg-gray-100 text-gray-900" : "text-gray-500 hover:text-gray-700 hover:bg-gray-50"}`}
            >
              Scheduled ({stats.scheduled})
            </button>
            <button className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 text-sm font-medium text-gray-500 hover:text-gray-700 hover:bg-gray-50 rounded-lg transition-colors whitespace-nowrap">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <button className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 border border-gray-200 rounded-lg text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors whitespace-nowrap">
